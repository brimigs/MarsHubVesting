...
import {
  ...
  VotingPowerResponse,
  ArrayOfVotingPowerResponse,
} from './MarsVesting.types'
export interface MarsVestingReadOnlyInterface {
  contractAddress: string
  config: () => Promise<InstantiateMsg>
  votingPower: ({ user }: { user: string }) => Promise<VotingPowerResponse>
  votingPowers: ({
    limit,
    startAfter,
  }: {
  ...
  position: ({ user }: { user: string }) => Promise<PositionResponse>
  positions: ({
    limit,
    startAfter,
  }: {
